...
<SCRIPT LANGUAGE="JavaScript" SRC="./INC/js/dragiframe.js"></SCRIPT>
<STYLE><!--
TD.cal 
{ 
	font-family: Tahoma; 
...
<body topmargin="0" leftmargin="0" rightmargin="0" bottommargin="0" MARGINWIDTH="0" MARGINHEIGHT="0" onLoad="getCalendar(); frm_resize(); addHandle(document.getElementById('pole'), window);" style="overflow:visible; border:0px; background-color: transparent">
<TABLE id="calend" name="calend" WIDTH="154" BORDER="1" BORDERWIDTH="1" BORDERCOLOR="#663333" CELLSPACING="0" CELLPADDING="0" BGCOLOR="white" style="font-family:Tahoma; font-size:8pt">
...
function getCalendar()
{
	...
	if (cal_obj.displayType=="date" || cal_obj.displayType=="week-end") 
	{
		...
		var date_class;
		result += '<TABLE WIDTH=154 BORDER=0 BORDERWIDTH=0 CELLSPACING=0 CELLPADDING=2 style="font:Tahoma; font-size:8pt">\n';
		...
		result += '</TR></TABLE>\n';
		result += '<TABLE WIDTH=120 BORDER=0 CELLSPACING=0 CELLPADDING=0 ALIGN=CENTER style="font:Tahoma; font-size:8pt">\n';
		result += '<TR>\n';
		var td = '	<TD CLASS="cal" ALIGN=RIGHT WIDTH=14%>';
		for (var j=0; j<7; j++) 
		  result += td+cal_obj.dayHeaders[(cal_obj.weekStartDay+j)%7]+'</TD>\n';
		result += '</TR>\n';
		result += '<TR><TD COLSPAN=7 BGCOLOR=#663333 ALIGN=CENTER><IMG SRC="<? echo WEBDIR;?>/images/graypixel.gif" WIDTH=120 HEIGHT=1></TD></TR>\n';
		...
		result += '<TR><TD COLSPAN=7 ALIGN=CENTER BGCOLOR=#663333><IMG SRC="<? echo WEBDIR; ?>/images/graypixel.gif" WIDTH=120 HEIGHT=1></TD></TR>\n';
		result += '<TR>\n';
	...
	if (cal_obj.displayType=="month" || cal_obj.displayType=="quarter" || cal_obj.displayType=="year") 
	{
		...
		{
			result += '<TABLE WIDTH="100%" BORDER=0 BORDERWIDTH=0 CELLSPACING=0 CELLPADDING=0 style="font:Tahoma; font-size:8pt">\n';
			result += '<TR BGCOLOR="#C0C0C0">\n';
			...
			result += '	<TD BGCOLOR="#C0C0C0" CLASS="cal" WIDTH=100 ALIGN=CENTER><B>'+year+'</B></TD>\n';
			result += '	<TD BGCOLOR="#C0C0C0" CLASS="cal" WIDTH=22 ALIGN=CENTER VALIGN=MIDDLE><B><A CLASS="cal" HREF="javascript:;" onClick="'+refresh+"('"+pole+"',"+(year+1)+');">&gt;&gt;</A></B></TD>\n';
			result += '</TR></TABLE>\n';
		}
	}
	...
	if (cal_obj.displayType=="month") 
	{
		...
		result += '<TABLE WIDTH=120 BORDER=0 CELLSPACING=2 CELLPADDING=2 ALIGN=CENTER style="font:Tahoma; font-size:8pt">\n';
		for (var i=0; i<4; i++) 
		{
			result += '<TR>';
			for (var j=0; j<3; j++) 
	...
	{
		result += '<BR><TABLE WIDTH=120 BORDER=1 CELLSPACING=0 CELLPADDING=0 ALIGN=CENTER style="font:Tahoma; font-size:8pt">\n';
		for (var i=0; i<2; i++) 
		{
			result += '<TR>';
			for (var j=0; j<2; j++) 
	...
	if (cal_obj.displayType=="year") 
	{
		...
		result += '<TABLE WIDTH=144 BORDER=0 BORDERWIDTH=0 CELLSPACING=0 CELLPADDING=0 style="font:Tahoma; font-size:8pt">\n';
		result += '<TR BGCOLOR="#C0C0C0">\n';
		...
		result += '	<TD BGCOLOR="#C0C0C0" CLASS="cal" WIDTH=50% ALIGN=CENTER VALIGN=MIDDLE><B><A CLASS="cal" HREF="javascript:;" onClick="'+refresh+"('"+pole+"',"+(year+(yearColumnSize*2))+');">&gt;&gt;</A></B></TD>\n';
		result += '</TR></TABLE>\n';
		result += '<TABLE WIDTH=120 BORDER=0 CELLSPACING=1 CELLPADDING=0 ALIGN=CENTER style="font:Tahoma; font-size:8pt">\n';
