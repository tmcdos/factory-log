...
if(isset($_POST['cmdSave']))
{
	...
	elseif(strlen($arr['NAME'])>48) $err='First and last name are longer than 50 symbols';
	...
	if($err=='')
	{
		...
		if($us) $err='This combination of username and password already exist ! Please choose another';
		else
		{
