...
function CalendarPopup(i_tag,cal_url) 
{
  ...
  if(!this.framer)
  {
	...
	this.monthNames = new Array('Януари','Февруари','Март','Април','Май','Юни','Юли','Август','Септември','Октомври','Ноември','Декември');
	this.monthAbbreviations = new Array('Януари','Февруари','Март','Април','Май','Юни','Юли','Август','Септември','Октомври','Ноември','Декември');
	this.dayHeaders = new Array("Н","П","В","С","Ч","П","С");
	this.weekStartDay = 0;
